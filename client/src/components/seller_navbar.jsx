                    ...
                    <nav className="flex justify-between bg-white-900 text-black w-full">
                        <div className="px-5 xl:px-12 py-3 flex items-center w-full">
                            ...
                            <div className="flex-grow flex items-center justify-end space-x-4">
                                <form className="mt-0 max-w-[250px] max-h-[40px] py-1 px-6 rounded-full bg-gray-50 border flex focus-within:border-gray-300">
                                    <input type="text" placeholder="Search for Books" className="font-bodoni-ferrara bg-transparent w-full focus:outline-none pr-4 font-semibold border-0 focus:ring-0 px-0 py-0" name="topic" />
                                    <button className="mt-0 font-bodoni-ferrara flex flex-row items-center justify-center min-w-[70px] px-4 rounded-full font-medium tracking-wide border disabled:cursor-not-allowed disabled:opacity-50 transition ease-in-out duration-150 text-base bg-black text-white font-medium tracking-wide border-transparent py-1 h-[27px] -mr-5">
                                        Search
                                    </button>
                                </form>
                                {/* Nav Links */}
