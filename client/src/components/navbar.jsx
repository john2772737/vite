          ...
          <nav class="flex justify-between bg-white-900 text-black w-screen">
            <div class="px-5 xl:px-12 py-6 flex w-full items-center">
              <a class="text-3xl font-bold font-heading hover:text-black-500">
                <li class="h-9" onClick={() => { setMenu("home") }} style={{ listStyleType: 'none' }}>
              ...
              <li class="hover:text-red-500">SELLER CENTRE</li>
              <li class="hover:text-red-500" onClick={() => { setMenu("live") }}>
                  <Link style={{ textDecoration: 'none', color: 'inherit' }} to='/user/live'>LIVE</Link>
                  {menu === "live" ? <hr className="hr-red" /> : <></>}
              </li>
              <li class="hover:text-red-500" onClick={() => { setMenu("cart") }}>
              ...
              <li class="hover:text-red-500" onClick={() => { setMenu("notif") }}>
