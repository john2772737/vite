        ...
        <div className="w-full mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-5xl">
          <div className="grid gap-12 lg:grid-cols-2">
            <div className="mt-15 lg:mt-0 text-left lg:text-left">
              <h1 className="mt-16 mb-8 text-4xl font-bold tracking-tight md:text-4xl xl:text-5xl font-bodoni-ferrara text-black">
                From Cart to Couch, <span>Your Book Awaits!</span>
              </h1>
              <p className="mt-2 mb-16 text-lg font-medium text-gray-800 font-bodoni-ferrara">
            ...
            <div className="mb-12 lg:mb-0 lg:mt-8">
